  ...
  return (
    <main className="flex min-h-screen flex-col justify-center bg-cream px-6 py-12">
      <div className="mx-auto w-full max-w-sm">
        ...
        {!session ? (
          <>
            <p className="mb-8 mt-4 text-center text-base text-muted">
              Ce lien n'est plus valide ou a déjà été utilisé. Demandez-en un
              nouveau depuis l'écran de connexion.
            </p>
            <Link
              to="/login"
              className="flex h-14 items-center justify-center rounded-full bg-terra text-lg font-semibold text-white transition active:brightness-90"
            >
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              <div className="flex flex-col gap-1">
                <label htmlFor="nouveau" className="text-sm font-semibold text-ink">
                  Nouveau mot de passe
                </label>
                <PasswordInput
                  id="nouveau"
              ...
              <div className="flex flex-col gap-1">
                <label htmlFor="confirmation" className="text-sm font-semibold text-ink">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="mt-2 h-14 rounded-full bg-terra text-lg font-semibold text-white transition active:brightness-90 disabled:opacity-60"
              >
